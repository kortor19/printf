...
/************PRINT UNSIGNED NUMBER IN ON OCTAL******************/
...
/**
 * print_hexadecimal - prints an unsignednumber in hexadecimal notation
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags: Calculative active flags
 * @width: get width
 * @precision: precision specification
 * @size: size specifier
 * Return: Number of chars printed
...
/*************** PRINT HEX IN NUM IN LOWER OR UPPER**************/
/**
